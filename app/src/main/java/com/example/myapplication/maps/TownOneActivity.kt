...
import com.example.myapplication.WarriorBuildingTownOneActivity
import com.example.myapplication.jobClasses.Warrior
...
class TownOneActivity : AppCompatActivity() {
    ...
    fun startRandomBattle(item: MenuItem) {
        ...
        val intent = Intent(this@TownOneActivity, CombatActivity::class.java)
        startActivity(intent)
    }

    fun switchToWarriorBuilding(view: View?) {
        // Create an intent to launch the BattleActivity
        val intent = Intent(this@TownOneActivity, WarriorBuildingTownOneActivity::class.java)
        startActivity(intent)
